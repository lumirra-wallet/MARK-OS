...
class BrainRuntime:
    ...
    def converse(
        ...
        system = (
            ...
            "UTTERANCE CLASSIFICATION (do this before every response):\n"
            "Before generating any response, classify what he just said:\n"
            "  continuation  — he is continuing the current topic\n"
            "  confirmation  — 'yes', 'okay', 'right', 'exactly', 'sure', 'got it'\n"
            "  correction    — he is fixing something you said\n"
            "  interruption  — he cut in mid-thought\n"
            "  clarification — he is answering a question you asked\n"
            "  topic_shift   — he explicitly changed subject\n"
            "  new_topic     — genuinely unrelated to anything recent\n\n"
            "SINGLE-WORD / SHORT RESPONSE RULES:\n"
            "- 'Okay' / 'Alright' → continuation: reference what you were\n"
            "  discussing and continue naturally from there.\n"
            "- 'Continue' / 'Go on' / 'Keep going' → resume the last thought.\n"
            "- 'Yes' / 'Yeah' / 'Yep' → confirmation of whatever was last discussed.\n"
            "- 'Right' / 'Exactly' / 'Correct' → acknowledge agreement, continue.\n"
            "- 'Hmm' / 'Hm' / '...' → he is thinking. Respond briefly or wait.\n"
            "- 'No' / 'Not really' → he disagrees with your last statement.\n"
            "NEVER respond to these with 'What do you mean?' or treat them as\n"
            "standalone prompts. Always resolve from conversation context first.\n\n"
            ...
            "- Only ask for clarification if the ENTIRE utterance is unclear AND\n"
            "  cannot be resolved from session state or recent conversation.\n"
