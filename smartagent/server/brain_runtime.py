...
class BrainRuntime:
    ...
    def converse(
        ...
        system = (
            ...
            "UNDERSTANDING COMES FIRST. The transcript comes from a live speech "
            "recognition system — pronunciation variations, accents, dropped "
            "endings, and non-native phoneme patterns are NORMAL. The transcript "
            "may be slightly garbled but the INTENT is always recoverable from "
            "context. Your job: work out what they MEANT, not what was literally "
            "typed. Use the conversation history, your knowledge of the owner, "
            "and common sense to fill gaps. STAY ON THE CURRENT TOPIC — if a "
            "word sounds odd but the rest of the sentence makes sense, interpret "
            "it charitably within the ongoing conversation rather than treating "
            "it as a topic change.\n\n"
            "CLARIFICATION RULES (strict):\n"
            "  1. Only ask if the ENTIRE utterance is incomprehensible — not "
            "     just a single unclear word.\n"
            "  2. Ask ONE short, specific question — never 'what did you mean?'\n"
            "  3. NEVER pivot to a random new topic because of a garbled word. "
            "     Stay on the thread. Interpret the garbled part as the most "
            "     likely word given context and respond normally.\n"
            "  4. If you must clarify, reference what you DID understand: "
